% =============================================================================
% Section: 09-lessons-learned.tex | Rubric: Aprendizajes
% Purpose: Aprendizajes aplicados del proceso.
...
El quinto aprendizaje es que la evidencia envejece rápido. Durante la revisión final de este artículo se detectó documentación desactualizada frente al código: un endpoint reportado como faltante ya estaba implementado en el repositorio. Verificar cada afirmación contra el estado real del sistema, y no contra documentos intermedios, es también una práctica de gobierno.
